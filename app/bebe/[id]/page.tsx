        ...
        {seccion === "recordatorios" && <div className="space-y-4">
          <div className="bg-white rounded-3xl shadow-sm border p-5 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div><label className="text-xs font-semibold text-purple-700 block mb-1">Tipo</label><select value={rType} onChange={e => setRType(e.target.value)} className="w-full border-2 border-purple-300 rounded-2xl px-3 py-2 text-sm text-slate-800 bg-white focus:outline-none focus:border-purple-600 focus:ring-2 focus:ring-purple-100"><option value="FORMULA">Formula</option><option value="TEMPERATURA">Temperatura</option><option value="MEDICINA">Medicina</option><option value="PESO">Peso</option></select></div>
            </div>
