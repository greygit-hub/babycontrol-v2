        ...
        {showForm ? (
          <div className="bg-white rounded-3xl border p-5 space-y-4">
            ...
            <form onSubmit={crearBebe} className="space-y-3">
              <div><label className="text-xs font-semibold text-purple-700 block mb-1">Nombre</label><input value={babyName} onChange={e => setBabyName(e.target.value)} placeholder="Sarilu" className="w-full border-2 border-purple-300 rounded-2xl px-4 py-3 text-sm text-slate-800 placeholder:text-purple-200 focus:outline-none focus:border-purple-600 focus:ring-2 focus:ring-purple-100" required /></div>
              <div><label className="text-xs font-semibold text-purple-700 block mb-1">Fecha de nacimiento</label><input type="date" value={birthDate} onChange={e => setBirthDate(e.target.value)} className="w-full border-2 border-purple-300 rounded-2xl px-4 py-3 text-sm text-slate-800 placeholder:text-purple-200 focus:outline-none focus:border-purple-600 focus:ring-2 focus:ring-purple-100" required /></div>
              <div><label className="text-xs font-semibold text-purple-700 block mb-1">Peso actual (kg)</label><input type="number" step="0.1" value={pesoKg} onChange={e => setPesoKg(e.target.value)} placeholder="3.5" className="w-full border-2 border-purple-300 rounded-2xl px-4 py-3 text-sm text-slate-800 placeholder:text-purple-200 focus:outline-none focus:border-purple-600 focus:ring-2 focus:ring-purple-100" required /></div>
